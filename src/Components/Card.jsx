...
function Card({data, reference}) {
  return (
    <motion.div drag dragConstraints={reference} whileDrag={{scale:1.17}} dragElastic={0.2} dragTransition={{ bounceStiffness: 300, bounceDamping: 10 }} 
    className='relative flex-shrink-0 w-60 h-72 rounded-[2.3rem] bg-zinc-900/90 text-white px-6 py-8 overflow-hidden'>
        <FaRegFileAlt/>
